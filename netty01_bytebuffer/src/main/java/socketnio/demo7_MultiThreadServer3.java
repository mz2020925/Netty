...
@Slf4j
public class demo7_MultiThreadServer3 {
    @Test
    ...
    /**
     * 在demo7_MultiThreadServer2中，不用队列，直接使用wakeup()，有机会可以成功，就是boss线程得手速快一点，把注册代码执行掉。但还是推荐用队列的方式
     * 请记住：selector阻塞期间是无法进行注册的，只能在非阻塞期间才能注册成功
     */
